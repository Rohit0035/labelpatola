...
const AccordionFeatur = ({ product }) => {
    return (
        <div className="accordion" id="accordionPanelsStayOpenExample">
            ...
            {/* Garment Care */}
            {
                product?.garment_care && product?.garment_care !== "" &&
            ...
            {
                product?.return_policy && product?.return_policy !== "" &&
            ...
            {
                product?.shipping_return && product?.shipping_return !== "" &&
            ...
            {/* Seller Information */}
            {
                product?.seller_information && product?.seller_information !== "" &&
