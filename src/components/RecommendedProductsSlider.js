      ...
      <div className="container px-3">
        <div className="d-flex align-items-center justify-content-between mb-5">
          ...
          <div className="recommended-products-swiper-nav d-flex align-items-center gap-3">
            <div ref={prevRef} className="slide-icon recommended-products-slider-icon-left">
              <i className="bi bi-arrow-left" />
            </div>
            <div ref={nextRef} className="slide-icon recommended-products-slider-icon-right">
              ...
              <div className="product-card border rounded-3 p-3">
                <div className="d-flex flex-column gap-3">
                  <div className="position-relative">
                    <a href="#">
                      <img src={product.image} className="product-img img-fluid rounded-3" alt={product.name} />
                    </a>
